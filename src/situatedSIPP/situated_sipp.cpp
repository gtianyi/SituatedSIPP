...
bool Situated_SIPP::findPath(unsigned int numOfCurAgent, const Map& map)
{
...
void Situated_SIPP::recordToOnlinePath(const Node&    rootNode,
...
Node Situated_SIPP::backupAndRecordPartialPlan(const Node&    curNode,
                                               const timeval& begin,
                                               const timeval& end)
{
    // Tianyi note: this goal test might be too much simplified, check
